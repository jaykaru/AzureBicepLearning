...
When creating Storage Account the name should not contain any hypen in between the name.

You can find the Storage Account Id under Storage Account Rg - Deployments - Outputs 